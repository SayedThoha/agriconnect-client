...
@Component({
  ...
  imports: [CommonModule,FormsModule,ReactiveFormsModule,FormsModule,CapitaliseFirstPipe],
...
export class KycVerificationComponent implements OnInit {
  ...
  // initialize_form(){
    ...
    this.kyc_verification_form.setValue({
      ...
      qualification_certificate: this.expert_kyc_details.qualification_certificate,
  ...
  submit_kyc_verification_form(){
    const data={
      ...
      current_working_address: this.kyc_verification_form.value.current_working_address ,
    }
